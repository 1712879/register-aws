            ...
            <Table>
              ...
              <TableBody>
                  {data &&
                    ...
                    <TableRow
                      hover
                        selected={!!listMonHoc.find(e => e.id == element.id)}
                    >
                      <TableCell >
                        <Box
                          sx={{
                      ...
                      <TableCell>
                        ...
                        <TableCell>
                          {!!listMonHoc.find(e => e.id == element.id) ? "" : <Button
                            sx={{ mx: 1 }}
                            color="info"
                            variant="contained"
                            onClick={() => handleSelectMonHoc(element.id)}
                          >
                            <CheckSquare size="20" />
                          </Button>}
                          ...
                          <Button
                            ...
                            color="error"
                            variant="contained"
                            onClick={() => handleDeleteMonHoc(element.id)}
                          >
                            <Trash2 size="20" />
                          </Button>
                        </TableCell>
